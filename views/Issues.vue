  ...
  <div>
      ...
      <v-card-text class="pa-4">
        <div class="d-flex align-center">
          ...
          <span class="text-body-1"
            >This page shows the history of devices that have been sent for repair (status changed
            from "Inactive" to "Under Repair").</span
          >
        </div>
      </v-card-text>
    </v-card>
    ...
    <v-card elevation="3">
      <v-card-title class="d-flex align-center py-3">
        ...
        <v-chip color="warning" size="small" class="ml-2" variant="outlined">
