    ...
    <v-container>
      <v-row>
        ...
        <v-col cols="12" md="6.5">
          <v-text-field
            ...
            label="Facility Name *"
            required
            :rules="[(v) => !!v || '단말기가 설치된 장비 명을 입력 해주세요']"
          ></v-text-field>
        </v-col>
      ...
      <v-row class="mt-4">
        <v-col class="d-flex justify-end">
          <v-btn color="grey" text class="mr-4" @click="$emit('cancel')"> 취소 </v-btn>
          <v-btn color="primary" type="submit" :disabled="!valid"> 저장 </v-btn>
        </v-col>
      </v-row>
    </v-container>
  </v-form>
