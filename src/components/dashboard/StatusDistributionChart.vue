  ...
  <v-card class="dashboard-card chart-card h-100">
    ...
    <v-card-text class="chart-card-content pa-0">
      <div class="chart-container-wrapper">
        ...
        <!-- Static legend for better stability -->
        <div class="static-legend">
          <div class="legend-item">
            <span class="status-dot status-active"></span>
            <span class="text-body-2">Active: {{ summary.status.active }}</span>
          </div>
          <div class="legend-item">
            <span class="status-dot status-inactive"></span>
            <span class="text-body-2">Inactive: {{ summary.status.inactive }}</span>
          </div>
          <div class="legend-item">
            <span class="status-dot status-repair"></span>
            <span class="text-body-2">Under Repair: {{ summary.status.under_repair }}</span>
          </div>
        </div>
      </div>
    </v-card-text>
