<template>
  <v-card class="system-card" elevation="3">
    ...
    <v-card-text class="py-3">
      <p class="text-body-2 text-medium-emphasis mb-3">{{ system.description || 'No description available' }}</p>
      
      <!-- Device Status Summary -->
      <div class="d-flex flex-column mb-3">
        <div class="d-flex align-center justify-space-between status-row">
          <div class="d-flex align-center">
            <v-icon color="primary" size="small" class="mr-2">mdi-devices</v-icon>
            <span class="text-body-2">Total Devices</span>
          </div>
          <v-chip
            color="primary"
            variant="outlined"
        ...
        <div class="d-flex align-center justify-space-between status-row">
          <div class="d-flex align-center">
            <v-icon color="warning" size="small" class="mr-2">mdi-wrench</v-icon>
